            ...
            <el-table
                ...
                <el-table-column
                    ...
                    <template slot-scope="scope">  
                        <span style="color:#00d053">{{ scope.row.temp }}</span>
                    </template>
                </el-table-column>
                <el-table-column
                    prop="hum"
                    ...
                    width="170">
                    <template slot-scope="scope">  
                        <span style="color:#f56767">{{ scope.row.hum }}</span>
                    </template>
                </el-table-column>
                <el-table-column
                    prop="light"
                    ...
                    width="170">
                    <template slot-scope="scope">  
                        <span style="color:#4db3ff">{{ scope.row.light }}</span>
                    </template>
                </el-table-column>
                <el-table-column
                    prop="time"
...
<!--                 
        ...
        <!-- 弹框页面 -->
        <DialogFound :dialog='dialog' :form='form' @update="getMonitor"></DialogFound>
    </div>
</template>
